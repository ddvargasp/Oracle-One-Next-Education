...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calcularValorHospedaje(txtFechaEntrada, txtFechaSalida);
			}
		});
	...
	protected void calcularValorHospedaje(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
		...
		if(fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			...
			Calendar entradaHuesped = fechaEntrada.getCalendar();
			Calendar salidaHuesped = fechaSalida.getCalendar();

			int dias = -1;
			int noche = 12000; 
			int valor;

			while(entradaHuesped.before(salidaHuesped)||entradaHuesped.equals(salidaHuesped)) {

				entradaHuesped.add(Calendar.DATE, 1);
				dias++;
			}
	...
	private void guardarReserva() {
		...
		if(txtFechaEntrada != null 
			...
			LocalDate fechaSalida = LocalDate.parse(((JTextField)txtFechaSalida.getDateEditor().getUiComponent()).getText());
