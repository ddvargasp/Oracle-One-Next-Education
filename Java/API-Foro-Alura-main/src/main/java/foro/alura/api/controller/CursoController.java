...
import foro.alura.api.domain.dto.curso.DatosListadoCurso;
import foro.alura.api.domain.dto.curso.DatosRegistroCurso;
import foro.alura.api.domain.dto.curso.DatosRespuestaCurso;
...
public class CursoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListadoCurso>> listadoCursos(@PageableDefault(size = 8) Pageable paginacion) {
